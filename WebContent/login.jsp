...
<head>
    ...
    <style type="text/css">
        ...
        .login-button{cursor: pointer;width: 100px;text-align: center;height: 40px;line-height: 40px;background-color: dodgerblue;border:none;margin: 0 auto;margin-top: 50px;color: white;display:block;margin:0px 35px; float: left}
        .reset-button{cursor: pointer;width: 100px;text-align: center;height: 40px;line-height: 40px;background-color: dodgerblue;border:none;margin: 0 auto;margin-top: 50px;color: white;display:block;margin:0 auto;}
    </style>
</head>
<body>
<form action="LoginServlet" method="post" onsubmit="return check()">
    <div class="login">
        ...
        <button  type="button" class="reset-button"><a href="register.jsp" style="display:block;">注册</a></button>
    </div>
</form>
</body>
